        ...
        <div className="h-screen w-screen flex bg-gradient-to-l from-fuchsia-100 to-violet-200">
            ...
            <div className="right h-[100%] w-[50%] flex justify-center items-center">
                <div className="card mt-5 h-[65%] w-[50%] text-center p-5 flex justify-center items-center flex-col rounded-xl shadow-lg gap-2 bg-gradient-to-r from-violet-200 to-violet-300">
                    ...
                    <input type="text" placeholder="email" name="email" className="h-10 w-65 shadow-md bg-gray-50 rounded p-2 mt-5"/>
                    <input type="text" placeholder="username" name="username" className="h-10 w-65 shadow-md bg-gray-50 rounded p-2 mt-5"/>
                    <input type="password" placeholder="password" name="password" className="h-10 w-65 shadow-md bg-gray-50 rounded p-2 mt-5"/>
                    <button className="mt-7 h-10 text-white shadow-md cursor-pointer text-lg rounded font-semibold w-25 bg-gradient-to-l from-violet-700 to-violet-500">Sign-up</button>
